...
int find_best_fit(struct header *free_list_ptr, uint64_t size) {
  ...
  for (struct header *crawler = free_list_ptr; crawler != NULL;
...
int find_worst_fit(struct header *free_list_ptr, uint64_t size) {
  ...
  for (struct header *block_ptr = free_list_ptr; block_ptr != NULL;
 ...
 * // ...
 * // If found, merge its size into newly_freed_block and remove it from the
 * list.
 * // ...
 *
 ...
 *
 * was_absorbed = FALSE
 * // Search free list for a prev_block where its end address equals
 * newly_freed_block's start address
 * // ...
 * // If found, merge newly_freed_block's size into prev_block and set
 * was_absorbed = TRUE.
 * // ...
 *
